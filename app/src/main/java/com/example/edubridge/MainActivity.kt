...
fun AppNavigation() {
    ...
    NavHost(
        ...
        composable(Destinations.LOGIN_ROUTE) {
            LoginScreen(
                onStudentLogin = {
                    ...
                    // para que no pueda volver al login con el botón de "atrás".
        ...
        composable(Destinations.STUDENT_HOME_ROUTE) {
            // TODO: Implementar StudentHomeScreen (Biblioteca, Eventos, Cuestionarios, Botón de Pánico)
            StudentHomeScreen()
        }

        // --- Panel de Control del Profesor ---
        composable(Destinations.TEACHER_DASHBOARD_ROUTE) {
            // TODO: Implementar TeacherDashboardScreen (CRUD: Avisos, Libros, Calendario, Validar Alertas)
